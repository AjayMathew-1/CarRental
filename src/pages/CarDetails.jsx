      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <img
            ...
            className="w-full h-auto md:max-h-[450px] object-cover rounded-xl shadow-md"
          />
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                >
                  <img src={item.icon} alt="" className="h-6 mb-2" />
        ...
        <form onSubmit={handleSubmit} className="shadow-lg h-max sticky top-24 rounded-xl p-6 space-y-6 text-gray-500 bg-white">
